  ...
  namespace :demo do
    ...
    #Create Industries in the Database
      ...
      industries.split(",")[0].each_with_index do |industry_name,count|       
       # Industry.populate.first do |industry|
    ...
    #     SubSection.populate(10..40) do |sub_section|
    #       sub_section.name = Populator.sentences(1..5)
    #       sub_section.description = Populator.sentences(1..15)
